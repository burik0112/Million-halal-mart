...
class Order(TimeStampedModel, models.Model):
    ...
    def get_order_items(self):
        ...
        """
        return self.orderitem.all().select_related("product", "product__product", "product__product__goods", "product__product__tickets", "product__product__phones").order_by("-pk")
