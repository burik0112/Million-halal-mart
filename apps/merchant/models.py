...
class Order(TimeStampedModel, models.Model):
    ...
    def get_order_items(self):
        ...
        """
        return self.orderitem.all().select_related("product", "product__images", "product__goods", "product__tickets", "product__phones").prefetch_related("product__phones", "product__tickets", "product__goods","product__images").order_by("-pk")
