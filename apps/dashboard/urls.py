...
urlpatterns = [
    ...
    path(
        ...
        login_required(SubCategoryCreateView.as_view()),
        name="subcategory-create",
    ),
    path(
        "product/subcategory/list/",
        login_required(SubCategoryListView.as_view()),
        name="subcategory-list",
    ),
    path(
        "product/subcategory/edit/<int:pk>/",
        login_required(SubCategoryEditView.as_view()),
        name="subcategory-edit",
    ),
    path(
        "product/subcategory/<int:pk>/detelet",
        login_required(SubCategoryDeleteView.as_view()),
